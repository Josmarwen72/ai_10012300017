"""Streamlit RAG Application - Academic City Assistant"""
                ...
                with st.container():
                    ...
                    <div class='chunk-card'>
                        ...
                        <div class='feedback-buttons'>
                            <button class='feedback-btn btn-up' onclick='streamlit_js_eval({{"func": "handle_feedback", "args": ["{chunk['source_id']}", "up"]}})'>👍</button>
                            <button class='feedback-btn btn-down' onclick='streamlit_js_eval({{"func": "handle_feedback", "args": ["{chunk['source_id']}", "down"]}})'>👎</button>
                        </div>
                    </div>
                    """, unsafe_allow_html=True)
                    
                    # Alternative feedback using buttons
